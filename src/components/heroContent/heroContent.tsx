      ...
      <div id={heroContentStyle.heroContainerMaster}>
        <div className={heroContentStyle.heroContentStyle_FirstSection}>
            ...
            <div style={{transform: growHeroImage, marginTop: marginDown, transition: 'all 0.3s ease'}} className={heroContentStyle.bigImageSectionOneHero}>
              <Image src={DashboardPhoto} width={999} height={999} alt="hero-image"></Image>
            {/* <video 
        ...
        <div className={heroContentStyle.heroContentStyle_Second_Section}>
          <div className={heroContentStyle.secondContentIn}>
            ...
            <div className={heroContentStyle.perfectForStyleInHero}>
              ...
              <Square squareClassName={heroContentStyle.squareClassName} squareTextColor="var(--textColor1)" squareText="Music Producers" squareTextP="Whether you're creating lofi, EDM, trap, or cinematic instrumentals, Euphoniczen helps you find playlists that feature your style. Filter through opportunities and connect with curators who actually want what you create." />
              ...
              <Square squareClassName={heroContentStyle.squareClassName} squareTextColor="var(--textColor1)" squareText="Record Labels" squareTextP="Euphoniczen makes it easy for labels to identify playlist opportunities for their artists. Search by genre or playlist name, then grab contact or submission details directly from playlist descriptions." />
            </div>
          </div>
        </div>
        {/*Third Section Hero*/}
