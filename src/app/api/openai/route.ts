...
export async function POST(req: NextRequest) {
  ...
  const instructionToComplete =
    "Based on the fetched data, return relevant information about the curator or platform. Please keep your reasoning/chat/your texts VERY SHORT & only share what is relvant like links to there playlists,  links to there profile, & people or data alike";
